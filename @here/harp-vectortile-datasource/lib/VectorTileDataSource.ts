...
export interface VectorTileDataSourceParameters extends DataSourceOptions {
    ...
    /**
     * Maximum geometry height above ground level this `OmvDataSource` can produce.
     *
     * @remarks
    ...
    /**
     * Minimum geometry height below ground level this `OmvDataSource` can produce. Negative values
     * describe height below ground.
     *
     * @remarks
